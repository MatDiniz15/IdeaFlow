    ...
    return (
        <View style={style.container}>
            ...
            <View style={style.boxMind}>
                ...
                />
                <TouchableOpacity onPress={() => navigation.navigate("BottomRoutes")}>
            ...
            <Text style={style.textBotton}>Não tem conta? <TouchableOpacity onPress={() => navigation.navigate("BottomRoutes")}> 
